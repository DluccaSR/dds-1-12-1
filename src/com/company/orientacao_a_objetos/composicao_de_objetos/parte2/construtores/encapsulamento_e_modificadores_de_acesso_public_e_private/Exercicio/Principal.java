...
public class Principal {
    public static void main(String[] args) {
        ...
        //ContaPagar contaPagar2 = new ContaPagar("Compras do mes", 390d, "19/05/1012", mercado);
        ContaPagar contaPagar2 = new ContaPagar();
        contaPagar2.setDescricao("Compras do mes");
        contaPagar2.setValor(390d);
        contaPagar2.setDataVencimento("19/05/1012");
        contaPagar2.setFornecedor(mercado);
        ...
        ContaReceber contaReceber2 = new ContaReceber("Manutenção em sistema de conta online", 53200d,
                "13/05/2012", telecom);
...
// Para chegar a essa conclusão, é só pensarmos: faz sentido, em um sistema financeiro, existir um objeto de uma pessoa?
// Quem seria essa pessoa? Um cliente? Um fornecedor? Um funcionário?
// Chegamos a conclusão que Pessoa é muito abstrata para ser instanciada, portanto, está mais do que claro que essa classe
// deve receber a palavra-chave abstract na declaração dela.
// Se pensarmos nesse mesmo sentido, a classe Conta também está eleita a ser abstrada, afinal, não existe motivo em termos uma instância apenas de Conta.
// Vamos analisar: qual seria o sentido de existir um objeto da classe Conta? Que tipo de conta seria? Conta a pagar? Conta a receber? Temos que transformar a classe Conta também em abstrata!
// Achou que o exercício seria apenas isso? Você se enganou! Vamos começar agora o desafio. :)
// Você precisa exibir relatórios de contas a pagar e receber, pois ajudará no controle do que tem para pagar e receber na empresa.
...
// Não seria uma boa prática essa classe obter os detalhes das contas para mostrá-los na tela
// por isso, temos uma excelente ideia de uso da orientação a objetos. Na classe Conta, adicione um método abstrato (não implementado).
